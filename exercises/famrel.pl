% the directive below is only needed for an exercise late in the semester
% please ignore for the time being, you will not even notice its effect right now
% (you can also delete it safely if it bothers you)
:- dynamic parent/2, male/1, female/1.


% some facts about three separate (unconnected) family trees
